...
# Project imports
from uwir.data.factory import get_euvp_training_set
...
def _make_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--amp", action="store_true", default=False,
                   help="Enable FP16 Automatic Mixed Precision on CUDA.")
    p.add_argument(
...
def train_one_run(
    ...
    print(f"  train={n_train}  val={n_val}  device={device}  amp={amp_enabled}")
