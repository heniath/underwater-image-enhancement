...
def option():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  Backbones: unet | unetpp | asppunet | mambabottleneck | mambaaspp | "
    ...
    # ------------------------------------------------------------------
    # Loss weights: lambda_1 * L_pixel + lambda_2 * L_perceptual + lambda_3 * L_SSIM
    # ------------------------------------------------------------------
    parser.add_argument(
        "--l1-weight",
        "--L1_weight",
        ...
        type=float,
        default=1.0,
        help="lambda_1 pixel-wise MAE loss weight",
    )
    parser.add_argument(
        "--perceptual-weight",
        "--perceptual_weight",
        type=float,
        default=1.0,
        help="lambda_2 VGG-16 perceptual loss weight",
    )
    parser.add_argument(
        "--ssim-weight",
        "--SSIM_weight",
